...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		autoChooser.addObject("Ramparts", new AutonomousRamparts());
		autoChooser.addObject("Low Bar", new AutonomousLowBar());
		autoChooser.addObject("Low Bar and Shoot", new AutonomousApproachGoal());
		...
		SmartDashboard.putData("Rotate to Target", new turnToTarget(false));
		...
		prefs.putDouble("shooter speed", RobotConstants.shooterSpeed);
	}
	...
	public void teleopInit() {
		...
		RobotConstants.shooterSpeed = prefs.getDouble("shooter speed", RobotConstants.shooterSpeed);
